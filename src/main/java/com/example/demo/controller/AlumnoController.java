...
public class AlumnoController {
	...
	@RequestMapping(value = "/alumnos/buscar/{nombre}", method = RequestMethod.GET, produces = "application/json")
	public List<Alumno> findTema(@PathVariable String nombre) {
		return alumnoService.findLikeNombre("%" + nombre + "%");
	}
